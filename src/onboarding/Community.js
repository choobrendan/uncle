...
const LANGUAGES = {
  en: {
    tasks: [
      {
        ...
        hints: [
          "Find the suitable icon in the navigation bar",
      ...
      },
      {
        ...
        additionalContext:
          "We need helpers for events and daily operations. Background check required.",
      },
      {
        id: "donation",
      ...
      },
      {
        ...
        additionalContext:
          "Monthly literary discussion group meeting in the community library.",
      },
    ],
    events: [
      {
    ...
    discover:
      "Discover programs, classes, and resources designed for our community.",
    ...
    parkingAccessibility:
      "Special parking arrangements available for mobility-impaired visitors. Please inquire at front desk for detailed information.",
...
const CommunityCenter = ({ setNextGame }) => {
  ...
  useEffect(() => {
    const randomTask =
      LANGUAGES[selectedLanguage].tasks[
        Math.floor(Math.random() * LANGUAGES[selectedLanguage].tasks.length)
      ];
    ...
    switch (activeSection) {
      case "events":
        return (
          <div className="section">
            <h2 class="onboarding">
              {LANGUAGES[selectedLanguage].upcomingEventsTitle}
            </h2>
              ...
              <div key={index}>
                ...
                >
                  {category.events.map((event, eventIndex) => (
                    <div
                      ...
                      onClick={() => {
                        ...
                        if (
                          ...
                          currentTask.id === "bookclub" &&
                          event.name.includes("Book Club")
                        ) {
                          handleTaskComplete();
                        }
                      }}
                    >
                      <h4>{event.name}</h4>
                      <p class="onboarding">{event.description}</p>
      ...
      case "classes":
        return (
          <div className="section">
            <h2 class="onboarding">
              {LANGUAGES[selectedLanguage].classRegistration}
            </h2>
            <form
              className="form"
              onSubmit={(e) => {
            ...
            >
              ...
              <select
                onChange={(e) =>
                  logInteraction("class_selection", { class: e.target.value })
                }
              >
      ...
      case "contact":
        return (
          <div className="section">
            <h2 class="onboarding">{LANGUAGES[selectedLanguage].contact}</h2>
            <div
              className="section-item"
              onClick={() => {
            ...
            <div className="text-small">
              <p class="onboarding">{LANGUAGES[selectedLanguage].address}</p>
              <p class="onboarding">{LANGUAGES[selectedLanguage].phone}</p>
              <p class="onboarding">{LANGUAGES[selectedLanguage].email}</p>
            </div>
          </div>
        );
      case "map":
        return (
          <div className="section">
            <h2 class="onboarding">
              {LANGUAGES[selectedLanguage].centerLocation}
            </h2>
            <div
            ...
            >
              ...
              <ul>
                <li>
                  {LANGUAGES[selectedLanguage].wheelchairAccessibleEntrance}
                </li>
      ...
      case "about":
        return (
          <div className="section">
            <h2 class="onboarding">{LANGUAGES[selectedLanguage].aboutUs}</h2>
            <div className="section-item">
              ...
              >
                ...
                />
                <button type="submit">
                  {LANGUAGES[selectedLanguage].signUpVolunteer}
                </button>
              </form>
            </div>
          </div>
      ...
      case "support":
        return (
          <div className="section">
            <h2 class="onboarding">{LANGUAGES[selectedLanguage].support}</h2>
            <div className="section-item">
              ...
              <form>
                ...
                >
                  {LANGUAGES[selectedLanguage].donateNow}
                </button>
              </form>
            </div>
          </div>
      ...
      default:
        return (
          <div className="section">
            <h2 class="onboarding">
              {LANGUAGES[selectedLanguage].currentTask}
            </h2>
            <p class="onboarding">{LANGUAGES[selectedLanguage].welcome}</p>
            <div className="grid">
              <div className="section-item">
                <h3>{LANGUAGES[selectedLanguage].latestNews}</h3>
                <p class="onboarding">
                  {LANGUAGES[selectedLanguage].latestNewsDesc}
                </p>
              </div>
              <div className="section-item">
                <h3>{LANGUAGES[selectedLanguage].upcomingEvents}</h3>
                <p class="onboarding">
                  {LANGUAGES[selectedLanguage].upcomingEventsDesc}
                </p>
              </div>
            </div>
          </div>
  ...
  return (
    <div className="container">
      ...
      {taskComplete && (
        ...
        >
          <p class="onboarding">
            Onboarding Done! Let's head back to the main page with all the
            changes!
          </p>
          <button
            style={{
