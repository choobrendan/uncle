  ...
  return (
    ...
    <div className="app-container" style={styles.appContainer}>
      ...
      <div className="navigation-bar" style={styles.navigationBar}>
        <div 
          ref={homeButtonRef}
          className={`nav-item ${currentPage === 'home' ? 'active' : ''} ${highlightedElement === 'home' ? 'highlighted' : ''}`}
          style={{
            ...styles.navItem,
            ...(currentPage === 'home' ? styles.activeNavItem : {}),
            ...(highlightedElement === 'home' ? styles.highlightedElement : {})
          }}
        ...
        <div 
          ref={searchButtonRef}
          className={`nav-item ${currentPage === 'search' ? 'active' : ''} ${highlightedElement === 'search' ? 'highlighted' : ''}`}
          style={{
            ...styles.navItem,
            ...(currentPage === 'search' ? styles.activeNavItem : {}),
            ...(highlightedElement === 'search' ? styles.highlightedElement : {})
          }}
        ...
        <div 
          ...
          className={`nav-item ${highlightedElement === 'create' ? 'highlighted' : ''}`}
          style={{
            ...styles.navItem,
            ...(highlightedElement === 'create' ? styles.highlightedElement : {})
          }}
          onClick={() => setShowCreatePostModal(true)}
        >
          <svg height="24" viewBox="0 0 24 24" width="24">
            <path d="M2 12v3.45c0 2.849.698 4.005 1.606 4.944.94.909 2.098 1.608 4.946 1.608h6.896c2.848 0 4.006-.7 4.946-1.608C21.302 19.455 22 18.3 22 15.45V8.552c0-2.849-.698-4.006-1.606-4.945C19.454 2.7 18.296 2 15.448 2H8.552c-2.848 0-4.006.699-4.946 1.607C2.698 4.547 2 5.703 2 8.552Z" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"/>
            <line fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" x1="12" x2="12" y1="8" y2="16"/>
            <line fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" x1="8" x2="16" y1="12" y2="12"/>
          </svg>
        </div>
        
        <div 
          ref={activityButtonRef}
          className={`nav-item ${currentPage === 'activity' ? 'active' : ''} ${highlightedElement === 'activity' ? 'highlighted' : ''}`}
          style={{
            ...styles.navItem,
            ...(currentPage === 'activity' ? styles.activeNavItem : {}),
            ...(highlightedElement === 'activity' ? styles.highlightedElement : {})
          }}
        ...
        <div 
          ...
          className={`nav-item ${currentPage === 'profile' ? 'active' : ''} ${highlightedElement === 'profile' ? 'highlighted' : ''}`}
          style={{
            ...styles.navItem,
            ...(currentPage === 'profile' ? styles.activeNavItem : {}),
            ...(highlightedElement === 'profile' ? styles.highlightedElement : {})
          }}
      ...
      <div className="command-input" style={styles.commandInputContainer}>
        <form onSubmit={handleInputSubmit} style={styles.commandForm}>
          ...
          />
          <button type="submit" style={styles.commandButton}>
            Process
          </button>
        </form>
      </div>
      ...
      <div className="stories-section" style={styles.storiesSection}>
        {mockUsers.map((user, index) => (
          <div 
            ...
            className={`story ${highlightedElement === 'story' && index === 0 ? 'highlighted' : ''}`}
            style={{
              ...styles.story,
              ...(highlightedElement === 'story' && index === 0 ? styles.highlightedElement : {})
            }}
          >
        ...
        {posts.map((post, index) => (
          <div key={index} className="post" style={styles.post}>
            ...
            <div className="post-actions" style={styles.postActions}>
              <div style={styles.postActionsLeft}>
                <div 
                  ...
                  className={`like-button ${highlightedElement === 'like' && index === 0 ? 'highlighted' : ''}`}
                  style={{
                    ...styles.actionIcon,
                    ...(highlightedElement === 'like' && index === 0 ? styles.highlightedElement : {})
                  }}
                >
                  <svg height="24" viewBox="0 0 24 24" width="24">
                    <path d="M16.792 3.904A4.989 4.989 0 0 1 21.5 9.122c0 3.072-2.652 4.959-5.197 7.222-2.512 2.243-3.865 3.469-4.303 3.752-.477-.309-2.143-1.823-4.303-3.752C5.141 14.072 2.5 12.167 2.5 9.122a4.989 4.989 0 0 1 4.708-5.218 4.21 4.21 0 0 1 3.675 1.941c.84 1.175.98 1.763 1.12 1.763s.278-.588 1.11-1.766a4.17 4.17 0 0 1 3.679-1.938m0-2a6.04 6.04 0 0 0-4.797 2.127 6.052 6.052 0 0 0-4.787-2.127A6.985 6.985 0 0 0 .5 9.122c0 3.61 2.55 5.827 5.015 7.97.283.246.569.494.853.747l1.027.918a44.998 44.998 0 0 0 3.518 3.018 2 2 0 0 0 2.174 0 45.263 45.263 0 0 0 3.626-3.115l.922-.824c.293-.26.59-.519.885-.774 2.334-2.025 4.98-4.32 4.98-7.94a6.985 6.985 0 0 0-6.708-7.218Z" fill="currentColor"/>
                ...
                <div 
                  ...
                  className={`comment-button ${highlightedElement === 'comment' && index === 0 ? 'highlighted' : ''}`}
                  style={{
                    ...styles.actionIcon,
                    ...(highlightedElement === 'comment' && index === 0 ? styles.highlightedElement : {})
                  }}
                >
                  <svg height="24" viewBox="0 0 24 24" width="24">
                ...
                <div 
                  ...
                  className={`share-button ${highlightedElement === 'share' && index === 0 ? 'highlighted' : ''}`}
                  style={{
                    ...styles.actionIcon,
                    ...(highlightedElement === 'share' && index === 0 ? styles.highlightedElement : {})
                  }}
                >
                  <svg height="24" viewBox="0 0 24 24" width="24">
              ...
              <div 
                ...
                className={`save-button ${highlightedElement === 'save' && index === 0 ? 'highlighted' : ''}`}
                style={{
                  ...styles.actionIcon,
                  ...(highlightedElement === 'save' && index === 0 ? styles.highlightedElement : {})
                }}
              >
                <svg height="24" viewBox="0 0 24 24" width="24">
            ...
            <div className="post-caption" style={styles.postCaption}>
              <span style={styles.postUsername}>{post.user.username}</span> {post.caption}
            </div>
    ...
    <div className="profile-page" style={styles.profilePage}>
      ...
      <div className="profile-header" style={styles.profileHeader}>
        <div style={styles.profileHeaderTop}>
          <div style={styles.profileUsername}>
            ...
            <div 
              ...
              className={`settings-button ${highlightedElement === 'settings' ? 'highlighted' : ''}`}
              style={{
                ...styles.settingsButton,
                ...(highlightedElement === 'settings' ? styles.highlightedElement : {})
              }}
            >
              <svg height="24" viewBox="0 0 24 24" width="24">
                <circle cx="12" cy="12" r="1.5" fill="currentColor"/>
        ...
        <div style={styles.profileInfo}>
          <div style={styles.profilePicSection}>
            <img src={user.profilePic} alt="Profile" style={styles.profilePageImage} />
          </div>
        ...
        <div style={styles.profileActions}>
          <button 
            ...
            className={`follow-button ${highlightedElement === 'follow' ? 'highlighted' : ''}`}
            style={{
              ...styles.profileActionButton,
              ...(highlightedElement === 'follow' ? styles.highlightedElement : {})
            }}
          >
            Follow
          </button>
          <button 
            ...
            className={`message-button ${highlightedElement === 'message' ? 'highlighted' : ''}`}
            style={{
              ...styles.profileActionButton,
              ...(highlightedElement === 'message' ? styles.highlightedElement : {})
            }}
          >
            Message
          </button>
      ...
      <div className="profile-posts" style={styles.profilePosts}>
        <div style={styles.profileTabsContainer}>
          ...
          <div style={styles.profileTab}>
            <svg height="24" viewBox="0 0 24 24" width="24">
              <path d="M18 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2Z" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"/>
          ...
          <div key={index} style={styles.activityItem}>
            ...
            <div style={styles.activityContent}>
              ...
              <span style={styles.activityText}>
                {index % 3 === 0 ? 'liked your photo.' : index % 3 === 1 ? 'started following you.' : 'commented: "Amazing post!"'}
              </span>
            </div>
        ...
        {Array(5).fill(0).map((_, index) => (
          <div key={index} style={styles.activityItem}>
            ...
            <div style={styles.activityContent}>
              ...
              <span style={styles.activityText}>
                {index % 3 === 0 ? 'liked your photo.' : index % 3 === 1 ? 'started following you.' : 'commented: "Great content!"'}
              </span>
            </div>
            ...
            <div className="upload-area" style={styles.uploadArea}>
              <div style={styles.uploadIcon}>
                <svg height="48" viewBox="0 0 48 48" width="48">
                  <path d="M38.5 33.5v-19c0-2.8-2.2-5-5-5h-19c-2.8 0-5 2.2-5 5v19c0 2.8 2.2 5 5 5h19c2.7 0 5-2.2 5-5zm-23-19c0-1.1.9-2 2-2h7.5v7.5h7.5V12.5h2c1.1 0 2 .9 2 2v7.5h-7.5v7.5h7.5v4c0 1.1-.9 2-2 2h-18c-1.1 0-2-.9-2-2v-19zm7.5 15v-7.5h-7.5v7.5h7.5z" fill="currentColor"/>
                </svg>
              </div>
